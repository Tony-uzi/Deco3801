const METADATA = {
  ...
  author: "WATER BOTTLE",
  name: "AI AGENT FOR SHAPEZ",
  version: "1.5",
  id: "AI MOD",
  description:
    "Get the real-time state of the game and print cachedHash in the console",
...
class Mod extends shapez.Mod {
  init() {
    ...
    document.addEventListener("keydown", (event) => {
      if (event.key === "F7") {
        event.preventDefault();
        console.log("F5 pressed! Opening Index.html...");
        window.open("Index.html", "_blank"); // 打开指定的 HTML 文件
      }
    });
  }
}
